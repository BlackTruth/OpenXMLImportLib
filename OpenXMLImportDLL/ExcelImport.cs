...
namespace OpenXMLImportDLL
{
    public class ExcelImport
    {
        ...
        public static int GenerateExcel(string filePath, int border)
        {
        ...
        private static void GenerateWorksheetPartContent(WorksheetPart worksheetPart)
        {
            ...
            foreach (CellData d in cellsData)
            {
                ...
                Cell cell = new Cell() { CellReference = GetExcelColumnName(j) + i };
        ...
        [System.Reflection.Obfuscation(Feature = "DllExport")]
        public static int AddCellData(int rowIndex, int colIndex, string data)
        {

            cellsData.Add(new CellData(rowIndex, colIndex, data));
    ...
    public class CellData
    {
        ...
        public CellData(int rowIndex, int colIndex, Object data)
        {
