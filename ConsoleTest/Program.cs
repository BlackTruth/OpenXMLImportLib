    ...
    class Program
    {
        ...
        static void AddExcel(string path)
        {
            for (int p = 1; p <= 1; p++)
            {
                ...
                //    for (int j = 1; j <= 150; j++)
                //    {
                //        int row = rnd.Next(1, 100);
                //        int column = rnd.Next(1, 100);
                //        OpenXMLImportDLL.ExcelImport.AddCellData(row, column, i + "|" + j, false, 10, false, 5, "Tahoma", false, true, 1, 1, false);
                //    }

                for (int i = 1; i <= 1000; i++)
                    for (int j = 1; j <= 500; j++)
                    {
                        OpenXMLImportDLL.ExcelImport.AddCellData(i, j, "1", false, 15, false, 5, "Tahoma", false, true, 1, 1, false);
                    }
                for (int i = 1; i <= 1000; i++)
                    for (int j = 1; j <= 500; j++)
                    {
                        OpenXMLImportDLL.ExcelImport.AddCellData(i, j, "22", false, 15, false, 5, "Tahoma", false, true, 1, 1, false);
                    }

                for (int i = 1; i <= 1000; i++)
                    for (int j = 1; j <= 500; j++)
                    {
                        OpenXMLImportDLL.ExcelImport.AddCellData(i, j, "333", false, 15, false, 5, "Tahoma", false, true, 1, 1, false);
                    }
                ...
                ////  OpenXMLImportDLL.ExcelImport.AddCellData(1, 1, "нф", false, 11, false, 5, "Tahoma", false, false, 200, 200, false);
